부산 중앙 중학교 (Busan Jungang Middle School)
=====================================
Copyright (C) 2014~2015 PDL <c1john@naver.com>
----------------------------------------------------------------------------------------------
...
* 수정 및 재배포시 앱 정보에 이 github.com주소를 추가해 주세요
...
* 이 앱의 일부(급식등)또는 전체(디자인~시간표등)를 사용할때 오픈소스 라이센스에 [원저작자 블로그 주소](http://itmir.tistory.com)또는 [원저작자 오픈소스 주소](https://bitbucket.org/whdghks913/wondanghighschool)를 추가한다면 사용가능 합니다
...
누구나 사용이 가능하며 사용시 앱의 오픈소스 라이센스에 [원저작자 오픈소스 주소](https://bitbucket.org/whdghks913/wondanghighschool)를 꼭 추가해야 합니다